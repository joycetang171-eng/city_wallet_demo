...
const elements = {
  ...
  offerDistance: document.getElementById("offerDistance"),
...
function resetCheckoutUI() {
  ...
  elements.redeemButton.classList.add("hidden");
...
function renderOffer() {
  ...
  elements.offerDistance.textContent = activeScenario.distance;
...
window.startRedemptionFlow = startRedemptionFlow;
window.declineOfferFlow = declineOfferFlow;
window.finishRedemptionFlow = finishRedemptionFlow;
